        ...
        with connection.begin():  # Start a transaction
            try:
                ...
                if "word_count" not in columns:
                    ...
                    connection.execute(
                        text("ALTER TABLE meeting ADD COLUMN word_count INTEGER;")
                    )
                else:
                ...
                if "duration_seconds" not in columns:
                    ...
                    connection.execute(
                        text("ALTER TABLE meeting ADD COLUMN duration_seconds INTEGER;")
                    )
                else:
                ...
                if "user_agent" not in columns:
                    ...
                    connection.execute(
                        text("ALTER TABLE meeting ADD COLUMN user_agent TEXT;")
                    )
                else:
