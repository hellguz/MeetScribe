...
class LocalSummaryRun(SQLModel, table=True):
    ...
    browser (Qwen3-4B via transformers.js/WebGPU), kept next to — never
    ...
    # ── What produced it ──────────────────────────────────────────────────
    # Hugging Face repo id, e.g. "webgpu/Qwen3-4B-ONNX". Older rows carry
    # the ids of models no longer offered; that is the point of storing it.
    model: str
    dtype: str
