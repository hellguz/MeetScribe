...
export default function Dashboard() {
	...
	const cardColors = {
		...
		purple: {
			bg: theme === 'light' ? '#f5f3ff' : '#2c1e48',
			border: theme === 'light' ? '#ddd6fe' : '#5b21b6',
			text: theme === 'light' ? '#5b21b6' : '#ddd6fe',
		},
	...
	return (
		<div
			...
			<div
				style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '32px', marginBottom: '32px', alignItems: 'flex-start' }}>
