			...
			{(isUiLocked || localChunksCount > 0) && (
				<div style={{ marginBottom: '12px' }}>
					<div
						...
						<div
							style={{
								...
								backgroundColor: transcribedColor,
								position: 'absolute',
								top: 0,
								left: 0,
								zIndex: 2,
					...
					<div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '14px', color: theme.secondaryText }}>
						<span>
							Uploaded: {uploadedChunks} / {realTotal}
						</span>
						<span>
							Transcribed: {transcribedChunks} / {realTotal} {transcriptionSpeedLabel && `(${transcriptionSpeedLabel})`}
						</span>
					</div>
				</div>
			)}
