...
const CHANGELOG: { when: string; lines: string[] }[] = [
	{
		...
		lines: [
			...
			'Nothing is downloaded until you press record. Having Local mode switched on no longer costs you a gigabyte just for opening the page.',
			...
			'🔒 / 🔗 beside a meeting is now a switch. The padlock explains what taking a meeting back would do before it does it; the link mark hands you a link to copy, for an hour, a week, or forever.',
